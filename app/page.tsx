      ...
      <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-8 max-w-7xl">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            ...
            <div className="flex-shrink-0 self-start sm:self-center">
              <button
                onClick={loadData}
                disabled={loading}
                className="px-4 py-2 bg-purple-600 hover:bg-purple-700 disabled:bg-gray-400 text-white rounded-md text-sm font-medium transition-colors flex items-center justify-center gap-2 whitespace-nowrap"
        ...
        {data.length > 0 && (
          <div className="mt-4 sm:mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4 sm:p-5 border border-purple-200 dark:border-purple-800">
              <p className="text-sm font-medium text-purple-600 dark:text-purple-400 mb-1">Total Servers</p>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 sm:p-5 border border-blue-200 dark:border-blue-800">
              <p className="text-sm font-medium text-blue-600 dark:text-blue-400 mb-1">Local Servers</p>
              <p className="text-2xl sm:text-3xl font-bold text-blue-900 dark:text-blue-100">
                {data[data.length - 1]?.localCount || 0}
              </p>
            </div>
            <div className="bg-pink-50 dark:bg-pink-900/20 rounded-lg p-4 sm:p-5 border border-pink-200 dark:border-pink-800">
              <p className="text-sm font-medium text-pink-600 dark:text-pink-400 mb-1">Remote Servers</p>
              <p className="text-2xl sm:text-3xl font-bold text-pink-900 dark:text-pink-100">
