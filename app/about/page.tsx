        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 mb-4 space-y-2">
                <li><strong>Local:</strong> Servers with <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">packages</code> property (installed via package managers)</li>
                <li><strong>Remote:</strong> Servers with <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">remotes</code> property (accessed via HTTP/SSE)</li>
