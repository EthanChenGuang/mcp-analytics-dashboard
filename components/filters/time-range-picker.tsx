  ...
  return (
    <div className="w-full sm:w-auto">
      <div className="flex flex-row items-end gap-3 sm:gap-4 flex-wrap">
        <div className="flex-shrink-0 min-w-[160px] sm:min-w-[180px]">
        ...
        {(startDate || endDate) && (
          <div className="flex items-end flex-shrink-0 pb-2">
            <button
              onClick={() => {
                onStartDateChange(null);
                onEndDateChange(null);
              }}
              className="px-4 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 underline transition-colors whitespace-nowrap"
